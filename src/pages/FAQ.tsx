        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="mt-12">
            ...
            <FAQItem
              ...
              answer="Nos cours sont principalement féminins, dans un espace bienveillant et sans jugement. Certains créneaux Kompa/Kizomba sont ouverts aux couples à renseignez-vous auprès du studio."
            />
            <FAQItem
